...
metodológica, se tomará el repositorio de Carlos Costa (Currency-Recognition); 
...
\begin{table}[h]
    \centering
    \caption{Resultados de reconocimiento de billetes}
    \begin{tabular}{l c l X} % l=left, r=right. Three columns total.
        \toprule
        \textbf{Fecha de la actividad} & 
        \textbf{Tiempo (hs)} & 
        \textbf{Miembro} &
